/*
*  En este ejemplo vamos a ver que no hace falta instanciar ningun objeto
*  para acceder a una variable 'static'.
*  La variable es VMAXIMA y se va a hacer la llamada y se va a printar por pantalla (linea 85)
* */
...
public class Coche {
    ...
    public static void main(String args[]) throws IOException {
        ...
        // Printar velocidad maxima
        System.out.println("Cuidado!!! La velocidad maxima es " + Coche.VMAXIMA + ". No la excedas!!!");  // Tambien vale VMAXIMA sin poner Coche ya que estan dentro de la misma clase
        System.out.println("");  // Una linea en blanco
